...
\begin{landscape}
\thispagestyle{empty}
\includepdf[angle=90, pagecommand={\null\enlargethispage{2\baselineskip}\vfill\captionof{figure}{Operativ performances}\label{fig:op}}]{dashboard/operative_performances.pdf}
\end{landscape}
\newpage
...
\begin{landscape}
\thispagestyle{empty}
\includepdf[angle=90, pagecommand={\null\enlargethispage{2\baselineskip}\vfill\captionof{figure}{Focus on old fleet}\label{fig:locai}}]{dashboard/comparison_arriva_locatelli.pdf}
\end{landscape}
\newpage
